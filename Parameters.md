...
u_g=Input--- (sigma0=Input)
Cl=0
Notice: You should a little bit play with these below parameters in order to reach the results of the table. These parameters are not exactly those parameters which have been used for conducting the experiments in the first stage of writing the paper.
```
