...
```
Features in images are relative from two perspectives which have been adressed as <em>relative*</em> and <b>relative**</b> in this document. We consider the edges as a manifest features in image processing.
## <i>Relative*</i>
